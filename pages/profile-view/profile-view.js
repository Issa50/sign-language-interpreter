...
export function addEventListeners(){
  Elements.allSeeProfileBtns.forEach(seeProfileBtn => {
    seeProfileBtn.addEventListener('click', async () => {
        history.pushState(null, null, routePath.PROFILE_VIEW);
        await profile_view_page();
    });
  })
   
}

export function profile_view_page(){
    let html = `<div class="container emp-profile">
    <form method="post">
        <div class="row">
            <div class="col-md-4">
                <div class="profile-img">
                <img
                src="/assets/imgs/channels4_profile-removebg-preview.png"alt=""/>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-work">
                    <p>SKILLS</p>
                    <a href="">Sign Language Translator</a><br/>
                    <a href="">English</a><br/>
                    <a href="">Zulu</a><br/>
